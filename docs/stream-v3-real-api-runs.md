...
run providers on page load. The Dell runtime payload was regenerated from a
development BigQuery-backed real-provider run after an earlier Cloud Run Gemini
attempt returned an empty candidate; the accepted Dell run has all five providers
schema-valid.
...
| Pipeline run | `pipe-31354926a1a942c39d39` | `pipe-1c22491f0c7b448aa3d1` |
| API revision | `dev-local-bigquery-20260629` | `ops-evidence-api-e2e-00006-6t9` |
| Canonical graph SHA256 | `95ef61f6e4486821429b648d2f707f13475e11a3867d53439b2d85660e5f39e5` | `3732e88c6e51596eba2331fc63f54dbe4d676da68cf0ad6e620759f39fcdfbf3` |
| Input fingerprint SHA256 | `75e0188cba1f4ec98903f48d74e12dd633bb8754705d0e245476f061145f6bcf` | `2b771e56c49ecf63b0eb5a97e9251ab837174f4476edc1eee61436684d2b1461` |
...
| --- | --- | --- | --- | ---: | ---: | ---: |
| `gemini-enterprise-agent-platform` | `gemini-3.1-pro-preview` | ok | valid | 59,962 | 55,587 | 1,328 |
| `openai-gpt-oss-on-vertex` | `gpt-oss-120b-maas` | ok | valid | 19,815 | 42,633 | 3,105 |
| `mistral-agent-platform` | `mistral-medium-3` | ok | valid | 32,163 | 52,432 | 1,119 |
| `qwen-agent-platform` | `qwen/qwen3-coder-480b-a35b-instruct-maas` | ok | valid | 12,636 | 49,412 | 1,526 |
| `glm-agent-platform` | `zai-org/glm-5-maas` | ok | valid | 64,972 | 43,141 | 4,837 |
