...
- `data/precomputed_review_summaries/a7fc02...50e0.json` - stream_v3 Dell runtime real API review cache from 45,000 staged rows, 27,926 accepted sanitized events, and 909 Evidence Items.
