...
| amazon-notify deterministic fixture | Offline regeneration path | `ee52464dffb1daebbfc4b2ac8e030d946367cb6ad54c3d4cb93391c69292d809` | Regenerated by `make demo` from committed public-safe logs. |
| payment-api sample | Compact smoke fixture | `90df7ce2f75392b1d2e0043f5e45076b223e9001d1eb1fde8bc83beeed0b42af` | Regenerated by `make demo-sample`. |
...
```text
http://127.0.0.1:8080/?evidence_sha256=ee52464dffb1daebbfc4b2ac8e030d946367cb6ad54c3d4cb93391c69292d809
```
...
- PostgreSQL chunk reuse is keyed by a versioned execution contract covering
  input, prompt, model, adapter, generation, response, and policy identity.
  Cross-run reuse is default-deny without a resolved model revision or explicit
  audited adapter policy.
