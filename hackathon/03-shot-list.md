...
| 11 | `assets/screenshots/18-rescore-before.png` | 10s | Start the amazon-notify narration about 3s early over the Fast Review result, cut to this image at 2:28, then hold on user_impact_unverified and Human Gate. Do not imply a return to stream_v3. |
