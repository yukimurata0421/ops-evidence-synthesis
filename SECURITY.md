...
- Sanitization and verification run locally before any GCP, BigQuery, Gemini, or review workflow receives data.
...
If you find a secret or sensitive operational detail in this repository, rotate the affected credential if applicable and remove it from Git history before publishing.
