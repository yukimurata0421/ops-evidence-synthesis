...
def _prompt(
    ...
    *,
    ...
    return (
        ...
        "evidence_refs are Evidence Items that directly ground the claim itself. "
        "counter_evidence_refs are Evidence Items that demonstrate the contradiction or rebuttal; "
        "they are not the identifiers of evidence being rebutted. A counter_evidence claim may use "
        "both arrays, but every referenced ID must exist in the bundle. "
    ...
    return _drop_empty(
        {
            ...
            "event_semantics": _truncate_nested(bundle.get("event_semantics") or [], max_text_chars),
    ...
    return _drop_empty(
        {
            ...
            "template_fingerprint": row.get("template_fingerprint"),
