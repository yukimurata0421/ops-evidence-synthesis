...
DEFAULT_RUNTIME_REVIEW_ID = "a7fc02ea095516eaaed07f4599c3e25f94d092163ed163efccfb6f0300ee50e0"
...
def main(argv: list[str] | None = None) -> int:
    ...
    _check_text(
        ...
        [
            ...
            "27,926 sanitized rows",
            "909/909 Evidence Item",
            "0 primary candidate(s)",
            "Review target requires validation: runtime_recovery",
