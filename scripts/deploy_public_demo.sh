...
gcloud run services update "${SERVICE_NAME}" \
  ...
  --update-env-vars "OES_UI_PRECOMPUTED_ONLY=1,OES_UI_FAST_INITIAL=1,OES_PUBLIC_FAST_GCP_REVIEW_ENABLED=1,OES_ENABLE_REAL_AI=1,OES_FAST_GCP_GEMINI_MODEL=gemini-3.1-flash-lite,OES_FAST_GCP_GEMINI_THINKING_LEVEL=minimal,OES_FAST_GCP_GEMINI_MAX_OUTPUT_TOKENS=4096,OES_FAST_GCP_GEMINI_TIMEOUT_SECONDS=45,OES_FAST_GCP_REVIEW_SAMPLE_ROWS=240"
